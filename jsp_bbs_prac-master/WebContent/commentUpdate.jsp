		...
		<div class="col-lg-10">
			<div class="jumbotron" style="padding-top: 1px;">				
				...
				<form name = c_commentUpdate>
					...
					<input type="button" onclick="send(<%=UserID %>,<%=bbsID %>,<%=commentID %>)" value="수정">
					<br><br>
...
<script>
	...
	function send(boardID,bbsID,commentID){
		...
		sb = "commentUpdateAction.jsp?UserID="+boardID+"&bbsID="+bbsID+"&commentID="+commentID+"&commentText="+commentText;
