...
public class Eva {
	...
	public String getEvaSubject() {
		return evaSubject;
	}
	public void setEvaSubject(String evaSubject) {
		this.evaSubject = evaSubject;
	}
	public String getEvaTeacher() {
		return evaTeacher;
	}
	...
	public void setEvaAvailable(int evaAvailable) {
